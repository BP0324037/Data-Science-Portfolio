...
Figure 2 - Class reference table to be read better by the python model.
...
Figure 3 - Conditional column checking if the stats allow a multiclass option.
...
Figure 4 - Column added determining number of stats above 12.
...
Figure 5 - The dataset was correlated to see anything noticeable.
...
Figure 6 - Removing illegal characters and checking for missing values.
...
Figure 7 - num_multiclass_options was added to see the number of players that met the requirements to multiclass.
...
Figure 8 - The column was then grouped.
...
Figure 9 - GroupBy Total_level to see at what levels Multiclassing increases.
...
Figure 11 - EDA on the train set
...
Figure 13 - printing the accuracy stats.
...
Figure 14 - coefficients and log odds are printed.
...
Figure 15 - Column chart for Not Multiclassed Vs Multiclassed.
